...
export default function Home() {
  return (
    <main className="container mx-auto px-4 py-16">
      {/* First Section Banner Part */}
      <div className="flex flex-col items-center gap-8 lg:gap-12 mb-16 lg:mb-24 lg:flex-row lg:justify-between">
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold pb-4 lg:pb-6 gradient-title">
            Simplify Your Scheduling
          </h1>
          <p className="text-xl text-gray-600 mb-6 lg:mb-10">
          ...
          <Link href="/dashboard">
            <Button size="lg" className="text-base sm:text-lg md:text-xl">
      ...
      {/* Second Section Key Features Part */}
      <div className="mb-24">
      ...
      {/* Third Section Testimonials Part */}
      <div className="mb-24">
        <h2 className="text-3xl font-bold text-center mb-12 text-blue-600">
          What Our Users Say
        </h2>
      ...
      {/* Fourth Section How It Work Part */}
      <div className="mb-24">
        <h2 className="text-3xl font-bold text-center mb-12 text-blue-600">
          How It Works
        </h2>
